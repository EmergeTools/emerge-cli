      ...
      class Snapshots < EmergeCLI::Commands::GlobalOptions
        ...
        def run_interactive_mode()
          ...
          begin
            ...
            excluded_previews = get_array_from_user(prompt, "Do you want to exclude any previews by exact match?", "Enter the previews you want to exclude (leave blank to finish)")
            excluded_regex_previews = get_array_from_user(prompt, "Do you want to exclude any previews by regex?", "Enter the previews you want to exclude (leave blank to finish)")
            arguments_array = get_array_from_user(prompt, "Do you want to set any arguments?", "Enter the argument you want to set (leave blank to finish)")
            env_variables_array = get_array_from_user(prompt, "Do you want to set any environment variables?", "Enter the environment variable you want to set (leave blank to finish) with format KEY=VALUE")
        ...
        def run_non_interactive_mode() 
          ...
          excluded_previews = get_parsed_previews(@options[:exact_match_excluded_previews] || [], @options[:regex_excluded_previews] || [])
        ...
        def get_os_version(prompt) 
          ...
          if os_version == "custom"
            os_version = prompt.ask("Enter the OS version you want to run the tests on")
          end
          return os_version
        end
